# Generated by Django 4.1.5 on 2023-03-23 08:33
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expense",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Dépenses"
                    ),
                ),
                (
                    "remaining_amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=15, verbose_name="Montant Restant"
                    ),
                ),
                ...
                (
                    "receipt",
                    models.FileField(
                        upload_to="Recu/%Y/%m/%d/", verbose_name="Reçu(pdf,image)"
                    ),
                ),
                ("active", models.BooleanField(default=True, verbose_name="Est actif")),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="business_sale_created_by",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="business_sale_shop",
                        to="dashboard_app.sale",
                    ),
                ),
            ],
            options={
