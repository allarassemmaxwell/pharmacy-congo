...
class Customer(models.Model):
    ...
    name = models.CharField(_("Nom du Client"), max_length=255, null=False, blank=False, unique=True)
    email = models.EmailField(_("Email"), max_length=255, null=False, blank=False)
    phone = models.CharField(_("Téléphone Client"), max_length=255, null=False, blank=False, unique=True)
    address = models.CharField(_("Addresse Client"), max_length=255, null=False, blank=False, unique=True)
    sex = models.CharField(_("Sexe"), max_length=100, choices=SEX_TYPES, null=True, blank=True)
    age = models.CharField(_("Age"), max_length=12)
    city = models.CharField(_("Ville du Client"), max_length=255, null=False, blank=False, unique=True)
...
class Invoice(models.Model):
    ...
    customer =  models.ForeignKey(Customer, on_delete=models.CASCADE, null=False, blank=False, related_name="customer")
    save_by = models.ForeignKey(User, on_delete=models.PROTECT)
    invoice_date_time = models.DateTimeField(auto_now_add=True)
    total = models.DecimalField(max_digits=10000, decimal_places=2)
    last_updated_date = models.DateTimeField(_("Modifier le"), auto_now_add=True, auto_now=False)
